...
bifactor_model <- "
# general factor
g =~ E1 + E6 + E7 + D1 + D6 + D7 + R1 + R3 + R7 + M1 + M3 + F1 + F3 + F6 + F10 + G5 + G2 + G9 + L5 + L6 + L7 + C2 + C3 + C6 + X4 + X8 + X9 + B3 + B4 + B5 + I1 + I2 + A1 + A3 + A5
...
o <- compareFit(fit1, fit2, fit3, fit4, fit5)
summary(o)
```
